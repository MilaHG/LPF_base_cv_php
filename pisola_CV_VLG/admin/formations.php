...
if (isset($_POST['r_titre'])) {// si on a posté une nouvelle comp.
    if ($_POST['r_titre'] != '' && $_POST['r_soustitre'] != '' && $_POST['r_dates'] != '' && $_POST['r_description'] != '') {// si compétence n'est pas vide
        ...
        $pdoCV->exec(" INSERT INTO t_realisations VALUES (NULL, '$r_titre', '$r_soustitre', '$r_dates', '$r_description', '$id_utilisateur') "); // $id_utilisateur qui vient de la variable de session
