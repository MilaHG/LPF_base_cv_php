...
if (isset($_POST['e_titre'])) {// si on a posté une nouvelle comp.
    if ($_POST['e_titre'] != '' && $_POST['e_soustitre'] != '' && $_POST['e_dates'] != '' && $_POST['e_description'] != '') {// si compétence n'est pas vide
        ...
        $pdoCV->exec(" INSERT INTO t_experiences VALUES (NULL, '$e_titre', '$e_soustitre', '$e_dates', '$e_description', '$id_utilisateur') "); // $id_utilisateur qui vient de la variable de session
